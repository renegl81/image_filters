...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
 <head>
  ...
  <body>
    <div class="container pt-3 mb-4 pm-3 bg-white">
        <div class="row mt-4 pt-4">
            <div class="card col-2 pl-0 pr-0 text-center">
                ...
                <div class="card-body">
                    ...
                    <div class="col-12 mt-3 text-center">
                        <button onclick="save()" class="btn btn-success">Guardar</button>
                    </div>
            ...
            <div id="canvas-container" style="height: 822px;width: 463px;overflow: hidden;">
  ...
  <script type="application/javascript" src="js/new_app.js"></script>
  </body>
</html>
